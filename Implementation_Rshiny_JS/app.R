...
server <- function(input, output) {
    ...
    onclick("btn_download", runjs("Btn(stock_event,link_event,head_fileds);Btn(stock_continuous_measurement,link_continuous_measurment,head_fields2);"))
    onclick("btn_clear", runjs("stock_event='';stock_continuous_measurement=''"))
